...
export const createCheckoutSession = async ( options?: Parameters<typeof customFetch>[1]): Promise<createCheckoutSessionResponse> => {
...
export const createPortalSession = async ( options?: Parameters<typeof customFetch>[1]): Promise<createPortalSessionResponse> => {
...
export const getSubscriptionStatus = async ( options?: Parameters<typeof customFetch>[1]): Promise<getSubscriptionStatusResponse> => {
