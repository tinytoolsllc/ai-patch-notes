...
export const getRelease = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<getReleaseResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetReleaseQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRelease>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getReleases = async (params?: GetReleasesParams, options?: Parameters<typeof customFetch>[1]): Promise<getReleasesResponse> => {
