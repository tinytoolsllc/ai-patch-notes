...
export const getPackages = async (params?: GetPackagesParams, options?: Parameters<typeof customFetch>[1]): Promise<getPackagesResponse> => {
...
export const getPackage = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<getPackageResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPackageQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPackage>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const updatePackage = async (id: string,
    updatePackageRequest: UpdatePackageRequest, options?: Parameters<typeof customFetch>[1]): Promise<updatePackageResponse> => {
...
export const getUpdatePackageMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePackage>>, TError,UpdatePackageMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePackage>>, TError,UpdatePackageMutationVariables, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePackage>>, UpdatePackageMutationVariables> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePackageMutationVariables = {id: string;data: UpdatePackageRequest}
...
export const deletePackage = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<deletePackageResponse> => {
...
export const getDeletePackageMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePackage>>, TError,DeletePackageMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deletePackage>>, TError,DeletePackageMutationVariables, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deletePackage>>, DeletePackageMutationVariables> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeletePackageMutationVariables = {id: string}
...
export const getPackageReleases = async (id: string,
    params?: GetPackageReleasesParams, options?: Parameters<typeof customFetch>[1]): Promise<getPackageReleasesResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPackageReleasesQueryKey(id,params);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPackageReleases>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getPackagesByOwner = async (owner: string,
    params?: GetPackagesByOwnerParams, options?: Parameters<typeof customFetch>[1]): Promise<getPackagesByOwnerResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPackagesByOwnerQueryKey(owner,params);
   ...
   return  { queryKey, queryFn, enabled: owner !== null && owner !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPackagesByOwner>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getPackageByOwnerRepo = async (owner: string,
    repo: string, options?: Parameters<typeof customFetch>[1]): Promise<getPackageByOwnerRepoResponse> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPackageByOwnerRepoQueryKey(owner,repo);
   ...
   return  { queryKey, queryFn, enabled: owner !== null && owner !== undefined && repo !== null && repo !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPackageByOwnerRepo>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
