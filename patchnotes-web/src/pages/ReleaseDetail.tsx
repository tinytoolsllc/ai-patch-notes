...
import { formatDateLong as formatDate, formatDateTime } from "../utils/dateFormat";
  ...
  if (error || !release) {
    return (
      <div className="min-h-screen bg-surface-secondary">
        ...
        <main className="py-8">
          <Container>
            <p className="text-text-secondary">The requested release could not be found.</p>
          </Container>
        </main>
      </div>
    );
    ...
    <div className="min-h-screen bg-surface-secondary">
      ...
      <main className="py-8">
        <Container>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {release.package.npmName && (
                    <p className="text-sm text-text-tertiary mt-0.5">{release.package.npmName}</p>
                  )}
                </div>
              </div>
              <time dateTime={release.publishedAt} className="text-sm text-text-tertiary">
          ...
          {/* Release Notes */}
          <section>
            <h2 className="text-xl font-semibold text-text-primary mb-4">Release Notes</h2>
            <Card>
              <CardContent className="mt-0">
                {release.body ? (
                  ...
                  <p className="text-text-tertiary italic">No release notes available.</p>
                )}
              </CardContent>
            </Card>
          </section>
