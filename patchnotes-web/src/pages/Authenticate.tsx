...
export function Authenticate() {
      ...
      <Container>
        <div className="flex min-h-screen flex-col items-center justify-center">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-major">Authentication Error</h1>
  ...
  return (
    <Container>
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-text-primary">Authenticating...</h1>
          <p className="mt-2 text-text-secondary">Please wait while we verify your credentials.</p>
        </div>
      </div>
    </Container>
  );
